function success = draw_tail_cap(r_cg, R)
%  Draws A Motor housing solid body
%
% ARGUMENTS:
...
props = get_body_params('HT_tail_cap');
...
tail_cap_patch = patch('Vertices', verticies_inertial, 'Faces', patch_faces);
set(tail_cap_patch, 'FaceAlpha', transparency);
set(tail_cap_patch, 'FaceColor', face_color);
set(tail_cap_patch, 'EdgeColor', edge_color);
success = 1;
end